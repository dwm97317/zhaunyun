    ...
    <div class="row">
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <form id="my-form" action="<?= url('store/package.newpack/newsavepackage')?>" class="am-form tpl-form-line-form" method="post">
                            ...
                            <div class="am-g">
                                <div class="am-u-sm-6">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-5 am-u-lg-3 am-form-label">模式选择 </label>
                                        <div class="am-u-sm-4 am-u-end">
                                            <button type="button" onclick="changemode(20)" id="zhiyou"  class="am-btn  <?= $set['moren']['pack_in_shop']==20?'am-btn-primary':'am-btn-default' ;?> am-radius">直邮</button>
                                            <button type="button" onclick="changemode(10)" id="pinyou" class="am-btn <?= $set['moren']['pack_in_shop']==10?'am-btn-primary':'am-btn-default' ;?> am-radius">拼邮</button>
                                            <input  name="data[mode_type]" type="hidden" id="pack_in_shop" value="<?= $set['moren']['pack_in_shop']==10?'10':'20' ?>" />
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-7 am-u-end">
                                            ...
                                            <input type="text" class="tpl-for-minput onepack <?= $set['moren']['pack_in_shop']==20?'show':'hidden' ;?>" onblur="checkexpress()"  id="express_num" name="data[express_num]" value="" placeholder="请输入包裹单号" required>
                                            
                                            <textarea  cols="200" rows="4" disabled="false" id="express_num"  class="am-form-field morepack <?= $set['moren']['pack_in_shop']==10?'show':'hidden' ;?>" name="data[express_num]"
                                                   placeholder="可输入多个快递单号,按换车换行" value=""></textarea>
                                            <div class="am-block">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end" style="position: relative">
                                             <div class="step_mode">
                                                 <div>
                                                     <div class="span">
                                                        <input type="text" class="vlength" class="tpl-form-input" onblur="getweightvol()" style="width:60px;border: 1px solid #c2cad8;" name="data[length][]" value="" placeholder="长<?= $set['size_mode']['unit'] ?>">
                                                     </div>
                                                     <div class="span">
                                                        <input type="text" class="vwidth" class="tpl-form-input" onblur="getweightvol()" style="width:60px;border: 1px solid #c2cad8;" name="data[width][]" value="" placeholder="宽<?= $set['size_mode']['unit'] ?>">
                                                     </div>
                                                     <div class="span">
                                                         <input type="text" class="vheight" class="tpl-form-input" onblur="getweightvol()" style="width:60px;border: 1px solid #c2cad8;" name="data[height][]" value="" placeholder="高<?= $set['size_mode']['unit'] ?>">
                                                     </div>
                                                     <div class="span">
                                                         <select class="wvop" onchange="getweightvol()" style="width:60px;border: 1px solid #c2cad8;" >
                                                     ...
                                                     <div class="span">
                                                         <input class="volume" type="text" class="tpl-form-input" style="width:80px;border: 1px solid #c2cad8;" name="data[volume][]" value="" placeholder="体积重<?= $set['size_mode']['unit'] ?>">
                                                     </div>
                                                     <div class="span">
                                                         <input type="text" id="weight" class="tpl-form-input" style="width:60px;border: 1px solid #c2cad8;" name="data[weigth][]" value="" placeholder="重量<?= $set['weight_mode']['unit'] ?>">
                                                     </div>
                                                     <div class="span">
                                                         <input type="text" id="num" class="tpl-form-input" style="width:50px;border: 1px solid #c2cad8;" name="data[num][]"
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-5 am-u-lg-3 am-form-label">物品明细</label>
                                        <div class="am-u-sm-9 am-u-end" style="position: relative">
                                             <div class="span">
                                             ...
                                             <div class="span">
                                                <input type="text" class="tpl-form-input" style="width:60px;border: 1px solid #c2cad8;" name="data[product_num]" value="" placeholder="数量">
                                             </div>
                                             <div class="span">
                                            ...
                                            <!--<div class="span mingxi">-->
                                            <!--     <span class="cursor" onclick="CategorySelect.display()">+</span>-->
                                            <!--</div>-->
                        	        ...
                        	        <?php endif; ?>
                                	<?php if (isset($set['is_open_shelf']) && $set['is_open_shelf']==1): ?>
                                    <div class="am-form-group">
                                        ...
                                        <table width="100%" class="am-table am-table-compact am-table-striped
                                         tpl-table-black am-text-nowrap">
                                            ...
                                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                             ...
                                             <?php $source = [1=>'小程序预报',2=>'从平台录入','3'=>'代购单同步',4=>'批量导入','5'=>'网页端录入','6'=>'拼团','7'=>'预约取件','8'=>'仓管录入']; ?>
                                                <tr>
...
<script language="JavaScript">
   ...
   var ddd =  <?= $set['moren']['pack_in_shop'] ?>;
   if(ddd==10){
	        $("#zhiyou").removeClass('am-btn-primary');
	        $("#pinyou").addClass('am-btn-primary');
	        $("#pack_in_shop").val('10');
	        
	        $(".onepack").addClass('hidden');
	        $(".onepack").removeClass('show');
	        $(".morepack").addClass('show');
	        $(".morepack").removeClass('hidden');
	        $(".morepack")[0].removeAttribute("disabled");
	      
	    }
	    
	    if(ddd==20){
	        $("#pinyou").removeClass('am-btn-primary');
	        $("#zhiyou").addClass('am-btn-primary');
	        $("#pack_in_shop").val('20');
	        
	        $(".onepack").addClass('show');
	        $(".onepack").removeClass('hidden');
	        $(".morepack").addClass('hidden');
	        $(".morepack").removeClass('show');
	        
	        $(".morepack")[0].setAttribute("disabled", "disabled");
	        console.log($(".morepack"));
	    }
...
<script>
    ...
    $('.j-selectUser').click(function () {
        ...
        $.selectData({
            ...
            dataIndex: 'user_id',
                ...
                console.log(data[0],4356);
                var user = [data[0]];
                $("#user_code").val(user[0]['user_code']);
                $("#member_id").val(user[0]['user_id']);
    ...
    function getweightvol(){
        var length = $(".vlength")[0].value;
        var width = $(".vwidth")[0].value;
        var height = $(".vheight")[0].value;
        var wvop = $(".wvop")[0].value;
    ...
    function addfreeRule(){
        ...
        var _html = '<div class="span"><input class="vlength" onblur="getweightvol()" type="text" class="tpl-form-input" style="width:60px;border: 1px solid #c2cad8;margin-right: 5px;" name="data[length][]" value="" placeholder="长<?= $set['size_mode']['unit'] ?>"></div><div class="span"><input type="text" class="tpl-form-input" style="width:60px;border: 1px solid #c2cad8;margin-right: 5px;" name="data[width][]"value="" onblur="getweightvol()" class="vwidth" placeholder="宽<?= $set['size_mode']['unit'] ?>"></div><div class="span"><input type="text" class="tpl-form-input" style="margin-right: 5px;width:60px;border: 1px solid #c2cad8;" name="data[height][]"value="" onblur="getweightvol()" class="vheight" placeholder="高<?= $set['size_mode']['unit'] ?>"></div><div class="span"><select  style="margin-right: 5px;width:60px;border: 1px solid #c2cad8;" ><option value="5000">5000</option><option value="6000">6000</option><option value="7000">7000</option><option value="8000">8000</option><option value="9000">9000</option><option value="10000">10000</option><option value="139">139</option><option value="166">166</option></select></div><div class="span"><input type="text" class="tpl-form-input" style="margin-right: 5px;width:80px;border: 1px solid #c2cad8;" name="data[volume][]"value="" class="wvop" placeholder="体积重<?= $set['size_mode']['unit'] ?>"></div><div class="span"><input type="text" id="weight" class="tpl-form-input" style="margin-right: 5px;width:60px;border: 1px solid #c2cad8;" name="data[weigth][]"value="<?= $data['weigth']??'' ;?>" placeholder="重量<?= $set['weight_mode']['unit'] ?>"></div><div class="span"><input type="text" id="weight" class="tpl-form-input" style="width:50px;border: 1px solid #c2cad8;margin-right: 5px;" name="data[num][]"value="1" placeholder="数量<?= $set['weight_mode']['unit'] ?>"></div><div class="span jiafa"><span class="cursor" onclick="addfreeRule(this)" style="display: inline-block; padding:0 5px; font-size:14px; background:#3bb4f2; margin-right:5px; color:#fff;">+</span></div><div class="span jiafa"><span class="cursor" onclick="freeRuleDel(this)" style="display: inline-block; padding:0 5px; font-size:14px; background:#3bb4f2; margin-right:5px; color:#fff;">-</span></div>';
