                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[province]"
                                           value="<?= $model['province'] ?>" placeholder="请输入省" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[city]"
                                           value="<?= $model['city'] ?>" placeholder="请输入市" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[region]"
                                           value="<?= $model['region'] ?>" placeholder="请输入区" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[street]"
                                           value="<?= $model['street'] ?>" placeholder="请输入街道" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[door]"
                                           value="<?= $model['door'] ?>" placeholder="请输入门牌" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[detail]"
                                           value="<?= $model['detail'] ?>" placeholder="请输入详细地址" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <input type="text" class="tpl-form-input" name="address[code]"
                                           value="<?= $model['code'] ?>" placeholder="请输入邮编" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">支持取货的邮编</label>
                                <div class="am-u-sm-9 am-u-md-6 am-u-lg-5 am-u-end">
                                    <textarea type="text" class="tpl-form-input" name="address[takecode]"
                                          placeholder="请输入邮编用英文逗号隔开（,）"><?= $model['takecode'] ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
