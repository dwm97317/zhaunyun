                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require"> 员工类型 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="1" data-am-ucheck
                                        <?= $model['clerk_type_arr']['s'] == 1 ? 'checked' : '' ?>>
                                        发货仓入库员
                                    </label>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="6" data-am-ucheck
                                        <?= $model['clerk_type_arr']['da'] == 6 ? 'checked' : '' ?>>
                                        到达仓入库员
                                    </label>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="2" data-am-ucheck
                                        <?= $model['clerk_type_arr']['f'] == 2 ? 'checked' : '' ?>>
                                        拣货员
                                    </label>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="3" data-am-ucheck
                                        <?= $model['clerk_type_arr']['d'] == 3 ? 'checked' : '' ?>>
                                        打包员
                                    </label>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="4" data-am-ucheck
                                        <?= $model['clerk_type_arr']['q'] == 4 ? 'checked' : '' ?>>
                                        签收员
                                    </label>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="5" data-am-ucheck
                                        <?= $model['clerk_type_arr']['c'] == 5 ? 'checked' : '' ?>>
                                        仓管员
                                    </label>
                                    <label class="am-checkbox-inline">
                                        <input type="checkbox" name="clerk[clerk_type][]" value="7" data-am-ucheck
                                        <?= $model['clerk_type_arr']['kf'] == 7 ? 'checked' : '' ?>>
                                        客服专员
                                    </label>
                                    <div class="help-block">
                                        <small>入库员: 包裹入库时,进行入库操作; 分拣员: 对入库的包裹进行分拣,上架,下架操作; 打包员: 对分拣下架后的包裹进行打包整理,并集中发货</small>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
