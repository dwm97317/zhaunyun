                        ...
                        <div class="am-tabs am-margin-top" data-am-tabs="{noSwipe: 1}">
                            ...
                            <div class="am-tabs-bd">
                                ...
                                <div class="am-tab-panel am-margin-top-lg" id="tab4">
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            ...
                                            <label class="am-checkbox-inline">
                                                <input type="checkbox" name="setting[settlement][pay_type][]" value="40"
                                                       data-am-ucheck
                                                    <?= in_array('40', $data['settlement']['values']['pay_type']) ? 'checked' : '' ?>>
                                                余额
                                            </label>
                                            <div class="help-block">
                                ...
                                <div class="am-tab-panel" id="tab5">
                                    ...
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">佣金明细页面</div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require">
                                            页面标题
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                        <textarea class="" rows="6" placeholder="请输入提现须知"
                                              name="setting[words][withdraw_apply][words][xieyi][value]"><?= $data['words']['values']['withdraw_apply']['words']['xieyi']['value'] ?></textarea>
                                        </div>
                                    </div>
