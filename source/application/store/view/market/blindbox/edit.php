                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group switch-coupon_type coupon_type__20 <?= $model['type'] == 20 ? '' : 'hide' ?>">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="blindbox[goods_name]"
                                           value="<?= $model['goods_name'] ?>" placeholder="请输入盲盒名称" required>
                                    <small>例如：老干妈</small>
                                </div>
                            </div>
                            <div class="am-form-group switch-coupon_type coupon_type__20 <?= $model['type'] == 20 ? '' : 'hide' ?>">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number"  class="tpl-form-input"
                                           ...
                                           value="<?= $model['goods_price'] ?>" placeholder="请输入物品的销售价" required>
                            ...
                            <div class="am-form-group switch-coupon_type coupon_type__20 <?= $model['type'] == 20 ? '' : 'hide' ?>">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="blindbox[goods_desc]"
                                           value="<?= $model['goods_desc'] ?>" placeholder="请输入盲盒描述" required>
                                    <small>例如：盲盒名称是老干妈，一种也让人喜爱的美食</small>
                                </div>
                            </div>
                            
                            <div class="am-form-group switch-coupon_type coupon_type__10 <?= $model['type'] == 10 ? '' : 'hide' ?>">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" min="0" max="100" class="tpl-form-input" name="blindbox[probability]"
                                           value="<?= $model['probability'] ?>" placeholder="请输入抽中概率" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="blindbox[status]" value="0" <?= $model['status'] == 0 ? 'checked' : '' ?>
                                               data-am-ucheck>
                                        参与
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="blindbox[status]" value="1" <?= $model['status'] == 1 ? 'checked' : '' ?>
                                               data-am-ucheck>
                                        不参与
                                    </label>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" min="0" class="tpl-form-input" name="blindbox[sort]" value="<?= $model['sort'] ?>"
                                           required>
                                </div>
                            </div>
                            <div class="am-form-group">
