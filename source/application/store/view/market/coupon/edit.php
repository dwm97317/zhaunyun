                ...
                <form id="my-form" class="am-form tpl-form-line-form" enctype="multipart/form-data" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">是否公开到领券中心 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[is_open]"
                                               value="0" <?= $model['is_open'] == 0 ? 'checked' : '' ?>
                                               data-am-ucheck>
                                        公开
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[is_open]" value="1"
                                            <?= $model['is_open'] == 1 ? 'checked' : '' ?>
                                               data-am-ucheck>
                                        不公开
                                    </label>
                                </div>
                            ...
                            <div class="am-form-group" data-x-switch>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[is_limit]" value="1"  <?= $model['is_limit'] == 1 ? 'checked' : '' ?>
                                               data-am-ucheck >
                                        只能领取一次
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="coupon[is_limit]" value="0"  <?= $model['is_limit'] == 0 ? 'checked' : '' ?>
                                               data-am-ucheck>
                                        不限制领取次数（使用完后即可再次领取）
                                    </label>
                                </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" min="0" class="tpl-form-input" name="coupon[use_point]"
                                           value="<?= $model['use_point'] ?>" required>
                                    <small>兑换此优惠券需要的积分数量，0为不参与兑换，大于0的数字即为兑换所需的积分数</small>
                                </div>
                            </div>
                            <div class="am-form-group">
